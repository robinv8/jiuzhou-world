            ...
            <div className="mx-auto max-w-7xl px-6 md:px-16 py-16 md:py-24">
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-12">
                    ...
                    <nav className="grid grid-cols-2 gap-x-16 gap-y-4">
                        <a href="/linan" className="group col-span-2">
                        ...
                        {[
                            { href: '/linan/mountains', label: nav.mountains },
                            { href: '/linan/scenic', label: nav.scenic },
                            { href: '/linan/history', label: nav.history },
                            { href: '/linan/culture', label: nav.culture },
                        ].map((l) => (
                            <a key={l.href} href={l.href} className="group pl-0">
                        ...
                        <a href="/about" className="group col-span-2 mt-2">
                ...
                <div className="mt-16 pt-8 border-t border-[#f7f5ee]/15 flex flex-col md:flex-row justify-between gap-4 text-xs tracking-widest text-[#f7f5ee]/50">
                    <span>
                        {pick({ zh: '九州志 · 一卷一城', en: 'Jiuzhou · one city, one volume' })}
                    </span>
